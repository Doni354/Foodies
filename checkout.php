...
if (isset($_POST['order_btn'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // Membuat kode acak sepanjang 6 karakter (angka)
        $pin_code = '';
        $characters = '0123456789';
        $codeLength = 6;

        for ($i = 0; $i < $codeLength; $i++) {
            $pin_code .= $characters[rand(0, strlen($characters) - 1)];
        }

        // Simpan kode acak ke variabel $_POST
        $_POST['pin_code'] = $pin_code;

        // Anda sekarang memiliki $pin_code yang berisi kode acak
        echo "Kode acak: " . $pin_code;
    }
    ...
    if ($cart_query && $detail_query) {
        ...
        <div class='message-container'>
            ...
            <div class='order-detail'>
                ...
                <span class='total'> total : Rp. ".$price_total.",00.  </span>
            </div>
        ...
        <section class="checkout-form">
            ...
            <form action="" method="post">
                <div class="display-order">
                    ...
                    ?>
                    <span class="grand-total"> grand total: Rp. <?= $grand_total; ?>,00. </span>
                </div>
                <div class="flex">
                    <div class="inputBox">
                        <span>your name</span>
                    ...
                    <div class="inputBox">
                        <span>state</span>
                        <input type="text" placeholder="e.g. Jawa Timur" name="state" required>
                    </div>
                    <div class="inputBox">
                        <span>country</span>
